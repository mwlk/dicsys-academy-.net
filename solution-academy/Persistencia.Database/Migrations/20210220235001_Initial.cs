        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FormaPago = table.Column<int>(type: "int", maxLength: 1, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cantidad = table.Column<int>(type: "int", maxLength: 2, nullable: false),
                    Subtotal = table.Column<float>(type: "real", nullable: false),
                    Tipo = table.Column<int>(type: "int", maxLength: 1, nullable: false),
                    Tamanho = table.Column<int>(type: "int", maxLength: 1, nullable: false)
                },
                constraints: table =>
                {
